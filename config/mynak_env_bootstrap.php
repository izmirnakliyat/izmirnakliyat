<?php
/**
 * .env yardımcıları — config.php / db.php içeriğinden ÖNCE yüklenir.
 * Canlıda eski config.php satır sırası veya eksik env_loader ile "mynak_env_str undefined" önlenir.
 */
